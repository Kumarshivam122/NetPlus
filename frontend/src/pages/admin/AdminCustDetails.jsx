...
export default function AdminCustDetails() {
  ...
  const reload = useCallback(async () => {
    ...
    // Only display retailers in the customer details tab
  ...
  return (
    <div className="portal-layout" id="admin-cust-details">
      <PortalSidebar title="Customer Details" />
      <main className="portal-main">
        <div className="portal-topbar">
          <div>
            <h4 style={{ color:'var(--navy)', fontFamily:'var(--font-display)' }}>Customer Details</h4>
