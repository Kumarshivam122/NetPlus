                  ...
                  <tbody>
                    {recentOrders.map(e => (
                      <tr key={e.id}>
                        ...
                        <td>
                          <span className={`badge badge-${e.status==='approved'?'success':e.status==='pending'?'warning':'danger'}`}>
                            {e.status}
                          </span>
                        </td>
                        <td style={{ fontSize:'.8rem' }}>{new Date(e.submittedAt).toLocaleDateString('en-IN')}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
