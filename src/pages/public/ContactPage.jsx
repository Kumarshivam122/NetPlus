    ...
    <div className="page-wrapper">
      ...
      <section className="page-hero" id="contact-hero">
        <div className="container">
          ...
          <p className="page-hero-sub">Have a question? Reach out to our team. We're here Mon–Sat, 9AM to 7PM.</p>
        </div>
      </section>
          ...
          <div className="contact-grid">
            ...
            <div className="contact-form-card animate-fade-up delay-200">
              {sent ? (
                ...
                <>
                  <h3 style={{ color: 'var(--navy)', marginBottom: '1.5rem' }}>Send a Message</h3>
